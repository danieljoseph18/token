 ...
 */
 //added capped functionality aswell
contract ERC20PresetMinterPauser is Context, AccessControlEnumerable, ERC20Burnable, ERC20Pausable {
    ...
    //IDEALLY should implement safemath to protect from overflows and underflows
    function _beforeTokenTransfer(
        ...
        //when tokens are minted (0 address) this check is run
        if(from == address(0)){
    ...
    function setCap(uint _newCap) public virtual {
        require(hasRole(CAPPER_ROLE, msg.sender),"Not permitted!");
        _cap = _newCap;
    } 
